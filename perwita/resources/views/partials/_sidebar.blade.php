                    ...
                    /*============== sub PENJUALAN LAPORAN========================*/
                     ...
                     /*============== END sub PENJUALAN ===================*/
                      ...
                      /*============== sub PEMBELIAN LAPORAN ========================*/
                            ...
                            /* faktur pajak */
                             /* faktur pajak */
                            Request::is('kartuhutang/kartuhutang') ? 'active' : '' || 
                            Request::is('kartuhutang/kartuhutang/*') ? 'active' : ''||
                            /**/
                    ...
                    <ul class="nav nav-second-level collapse">
                     ...
                     /*============== END sub PEMEBLIAN LAPORAN===================*/
                        ...
                        ">
                            ...
                            Request::is('sales/laporan/*') ? 'active' : ''}}" href={{url('sales/laporan')}}><i class="fa fa-folder-open-o" aria-hidden="true"></i><strong>Laporan   </strong> <i class="fa fa-cog fa-spin pull-right" aria-hidden="true"></i></a>
                                </li>

                                 <li >
                                    <a class="sidebar master-perusahaan {{Request::is('fakturpajakmasukan/fakturpajakmasukan') ? 'active' : '' || 
                            Request::is('fakturpajakmasukan/fakturpajakmasukan/*') ? 'active' : ''}}" href="{{ url('fakturpajakmasukan/fakturpajakmasukan')}}"><i class="fa fa-folder-open-o" aria-hidden="true"></i> Faktur Pajak </a>
                                </li>

                                <li >
                                    <a class="sidebar master-perusahaan {{Request::is('kartuhutang/kartuhutang') ? 'active' : '' || 
                            Request::is('kartuhutang/kartuhutang/*') ? 'active' : ''}}" href="{{ url('kartuhutang/kartuhutang')}}"><i class="fa fa-folder-open-o" aria-hidden="true"></i> Kartu Hutang </a>
                                </li>
